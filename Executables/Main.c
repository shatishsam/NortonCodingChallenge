...
* arguments- user file name from where the content has to be copied
* return- none
*/
void parseFileAndStore(char *userFileName)
{
...
/*this function takes arguments from application.exe processes and does appropirate action
* arguments- argument length, argument array
*/
